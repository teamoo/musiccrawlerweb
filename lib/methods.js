...
.methods({
    ...
    this.unblock();	
	var result = Meteor.http.post("http://" + Meteor.settings.linkbuilder.host + ":" + Meteor.settings.linkbuilder.port + "/musiccrawler/checkmusicdownloadlink",{data: {url: refreshurl, source: alink.source}, timeout: 20000});
    ...
    createLink : function(linkurl) {
		...
		var result = Meteor.http.post("http://" + Meteor.settings.linkbuilder.host + ":" + Meteor.settings.linkbuilder.port + "/musiccrawler/checkmusicdownloadlink",{data: {url: cleanlinkurl, source: userid, creator: userid}, timeout:20000});
