...
.methods({
    ...
    createLink : function(linkurl) {
		...
		var result = Meteor.http.post("http://localhost:10050/musiccrawler/checkmusicdownloadlink",{data: {url: cleanlinkurl, source: Meteor.userId(), creator: Meteor.userId()}, timeout:20000});
