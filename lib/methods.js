...
Meteor.methods({
	...
	getSuggestionsForSearchTerm: function (searchterm) {
		...
		return _.uniq(_.map(_.pluck(ret, 'name'), function (text) {
			if (text.length > 45) return text.substr(0, 44);
			return text;
		}));
	},
	*/
	getSuggestionsForSearchTermV2: function (searchterm) {
		...
		searchterm_mod = searchterm_mod.trim().replace(".*","");
							                                	...
							                                	<table border=\"0\" cellpadding=\"10\" cellspacing=\"0\" width=\"600\" id=\"templateFooter\">\
							                                    	<tr>\
							                                        	<td valign=\"top\" class=\"footerContent\">\
							                                                                 <div>\
							                                                                 Falls du den  <a href=\"http://static.133.169.9.176.clients.your-server.de:3000/\" target=\"_blank\">MusicCrawler</a> noch nicht kennst, kein Problem: Du kannst dich ganz einfach mit deinem Facebook-Account kostenlos anmelden.\
							                                                                 </div>\
							                                            </td>\
							                                        </tr>\
							                                    </table>\
