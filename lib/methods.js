...
.methods({
    ...
    this.unblock();	
	var result = Meteor.http.post("http://localhost:443/musiccrawler/checkmusicdownloadlink",{data: {url: refreshurl}, timeout: 20000});
    ...
    createLink : function(linkurl) {
		...
		var userid = Meteor.user().profile.id;
		
		var result = Meteor.http.post("http://localhost:443/musiccrawler/checkmusicdownloadlink",{data: {url: cleanlinkurl, source: userid, creator: userid}, timeout:20000});
	...
	scheduleCrawl : function(aFeedurl) {
		...
		{
			this.unblock();
			Meteor.http.post("http://localhost:6800/schedule.json", {data:{project:musiccrawler,spider:feedspider, feedurl:aFeedurl}, timeout: 3000})
	...
	cancelCrawl : function(aJobId) {	
		...
		{
			this.unblock();
			Meteor.http.post("http://localhost:6800/cancel.json", {data:{project:musiccrawler,job:aJobId}, timeout: 3000})
