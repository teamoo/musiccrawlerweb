...
.methods({
	...
	if (result && result.statusCode === 200)
	{
		...
		{			
			...
			throw new Meteor.Error(result.statusCode,"Fehler bei der Serverkommunikation","Fehler beim aktualisieren des Links " + refreshurl + " : ungültige Antwort vom Server");	
		}
		throw new Meteor.Error(result.statusCode,"Fehler bei der Serverkommunikation","Fehler beim aktualisieren des Links " + refreshurl + " : ungültige Antwort vom Server");	
	}
	throw new Meteor.Error(result.statusCode,"Server antwortet nicht","Fehler beim aktualisieren des Links " + refreshurl + " : keine Antwort vom Server");	
    },
